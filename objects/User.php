...
class User implements CastToArray {
    ...
    public static function getById(int $id) : ?self {
        $sql = "SELECT id, username, registration_date FROM " . Database::DB_NAME . "." . self::TABLE_NAME . " WHERE id = ?";
    ...
    public static function getByUsername(string $username) : ?self {
        $sql = "SELECT id, username, registration_date FROM " . Database::DB_NAME . "." . self::TABLE_NAME . " WHERE username = ?";
    ...
    public static function canConnect(string $username, string $password) : bool {
        $sql = "SELECT hash FROM " . Database::DB_NAME . "." . self::TABLE_NAME . " WHERE username = ?";
